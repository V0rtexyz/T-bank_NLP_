"""
Скрипт для авторизации Telegram клиента и создания файла сессии.
Запустите этот скрипт один раз для создания файла сессии.

Использование:
    poetry run python src/tplexity/tg_parse/authorize_telegram.py
"""
...
# Определяем путь к файлу сессии (в корне проекта)
